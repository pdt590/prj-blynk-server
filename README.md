...
![Dashboard settings](docs/overview/dash_settings.png)
...
- [Peterkn2001/blynk-server](https://github.com/Peterkn2001/blynk-server)

# Content 

- [What is Blynk?](#what-is-blynk)
- [Inspiration](#inspiration)
- [Content](#content)
- [GETTING STARTED](#getting-started)
  - [Blynk server](#blynk-server)
  ...
  - [Docker container setup](#docker-container-setup)
    ...
    - [Quick Launch on Raspberry Pi](#quick-launch-on-raspberry-pi)
  ...
  - [App and sketch changes](#app-and-sketch-changes)
  - [Advanced local server setup](#advanced-local-server-setup)
  - [Administration UI](#administration-ui)
    - [Turn off chrome https warning on localhost](#turn-off-chrome-https-warning-on-localhost)
  - [HTTP/S RESTful](#https-restful)
    - [Enabling sms on local server](#enabling-sms-on-local-server)
  - [Enabling raw data storage](#enabling-raw-data-storage)
      - [1. Enabling raw data on server](#1-enabling-raw-data-on-server)
      - [2. Install PostgreSQL. Option A](#2-install-postgresql-option-a)
      - [2. Install PostgreSQL.  Option B](#2-install-postgresql--option-b)
      - [3. Download Blynk DB script](#3-download-blynk-db-script)
      - [4. Move create_schema.sql and reporting_schema.sql to temp folder (to avoid permission problems)](#4-move-create_schemasql-and-reporting_schemasql-to-temp-folder-to-avoid-permission-problems)
      - [5. Connect to PostgreSQL](#5-connect-to-postgresql)
      - [6. Create Blynk DB and Reporting DB, test user and tables](#6-create-blynk-db-and-reporting-db-test-user-and-tables)
      - [Quit](#quit)
    - [CSV data format](#csv-data-format)
    - [Automatic Let's Encrypt certificates generation](#automatic-lets-encrypt-certificates-generation)
    ...
    - [Port forwarding for HTTP/S API](#port-forwarding-for-https-api)
    - [Enabling QR generation on server](#enabling-qr-generation-on-server)
    - [Behind wifi router](#behind-wifi-router)
    - [How to build](#how-to-build)
    - [How Blynk Works?](#how-blynk-works)
    - [Blynk protocol](#blynk-protocol)
      - [Hardware side protocol](#hardware-side-protocol)
      - [Mobile app side protocol](#mobile-app-side-protocol)
      - [Websockets web side protocol](#websockets-web-side-protocol)
  - [Licensing](#licensing)
